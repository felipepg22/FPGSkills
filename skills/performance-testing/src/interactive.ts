...
const TARGET_OPTIONS: TargetOption[] = [
  { value: "codex", label: "Codex", hint: ".codex/skills/performance-testing" },
  { value: "opencode", label: "OpenCode", hint: ".opencode/skills/performance-testing" },
  { value: "cursor", label: "Cursor", hint: ".cursor/skills/performance-testing" },
  { value: "claude-code", label: "Claude Code", hint: ".claude/skills/performance-testing" },
  { value: "antigravity", label: "Antigravity", hint: ".agents/skills/performance-testing" },
...
export async function runInteractiveInstall(
  ...
  prompter.intro("Performance Testing installer");
  ...
  progress.start("Installing Performance Testing");
  try {
    ...
    prompter.outro(failures ? "Review the failed targets above." : "Performance Testing is ready to use.");
    return results;
  } catch (error) {
