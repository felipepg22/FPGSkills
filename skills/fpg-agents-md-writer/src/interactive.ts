...
const TARGET_OPTIONS: TargetOption[] = [
  { value: "codex", label: "Codex", hint: ".codex/skills/fpg-agents-md-writer" },
  { value: "opencode", label: "OpenCode", hint: ".opencode/skills/fpg-agents-md-writer" },
  { value: "cursor", label: "Cursor", hint: ".cursor/skills/fpg-agents-md-writer" },
  { value: "claude-code", label: "Claude Code", hint: ".claude/skills/fpg-agents-md-writer" },
  { value: "antigravity", label: "Antigravity", hint: ".agents/skills/fpg-agents-md-writer" },
...
export async function runInteractiveInstall(
  ...
  prompter.intro("FPG AGENTS.md Writer installer");
  ...
  progress.start("Installing FPG AGENTS.md Writer");
  try {
    ...
    prompter.outro(failures ? "Review the failed targets above." : "FPG AGENTS.md Writer is ready to use.");
    return results;
  } catch (error) {
